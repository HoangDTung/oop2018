...
public class StudentManagement {
    ...
    public static void main(String[] args) {
        ...
        students[0].setName("Hoàng Duy Tùng");
        students[0].setID("17021112");
        students[0].setGroup("INT22041");
        students[0].setEmail("17021112@vnu.edu.vn");
        System.out.println(students[0].getInfo());
        //sinh vien 2
        students[1] = new Student();
        System.out.println(students[1].getInfo());
        //sinh vien 3
        students[2] = new Student("Nguyen Van A", "17020000", "17020000@vnu.edu.vn");
        System.out.println(students[2].getInfo());
        //sinh vien 4
        students[3] = new Student("Nguyen Van B", "17021111", "17021111@vnu.edu.vn");
